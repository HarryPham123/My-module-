...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ##diplomacy begin
	"the year is 1618, Europe is in turmoil and deadliest religion war resulting in eight million casualties. Initially a war between various Protestant and Catholic states in the fragmented Holy Roman Empire  it gradually developed into a more general conflict involving most of the great powers. this war it bring damage to every country there is no winner or loser, in this Thirty years war these soldier they still raise their country banner , load the cannon load the musket even they knew that they dont have a chance to survive they marching forward to fight back thier enemies. Which nation you will help them or you will lead your men and made your own country in this bloodiest war .",
    ##diplomacy end
	"none",
    [],
    [
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about these wars and their kingdoms, you...",
    ...
    [
      ("town_1",[            
       ...
       ],"Join a caravan to Warsaw, in the Polish-Lithuanian Commonwealth.",
       [
         (assign, "$current_town", "p_town_1"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Warsaw"),		 
	  ...
	  (eq, "$kaos_kings_kingdom", 0), 
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
       ],"Join a caravan to Moscow, in the Muscovite Tsardom.",
       [
         (assign, "$current_town", "p_town_8"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Moscow"),
	  ...
	  (eq, "$kaos_kings_kingdom", 0), 
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
       ],"Join a caravan to Sofia, in the Ottoman Empire.",
       [
         (assign, "$current_town", "p_town_10"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Sofia"),
	...
	],"Take a ship to Stockholmh, in the Kingdom of Sweden.",
       [
         (assign, "$current_town", "p_town_52"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Stockholmh"),		 
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
         (change_screen_return),
       ]),
      ...
      ("town_5",[
          (eq, "$kaos_kings_kingdom", 0), 
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
        ],"Take a ship to Hamburg, in the Holy Roman Empire.",
       [
         (assign, "$current_town", "p_town_26"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Hamburg"),
      ...
      ("town_6",[
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
        ],"Join a caravan to Aalborg, in the Kingdom of Denmark.",
       [
         (assign, "$current_town", "p_town_23"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Aalborg"),
	 ...
	 ("town_7",[
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
       ],"Join a caravan to Prague, in the Palatinate.",
       [
         (assign, "$current_town", "p_town_55"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Prague"),		 
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
         (change_screen_return),
       ]),
	  ...
	  ("town_8",[            
	       (eq, "$kaos_kings_kingdom", 0), 
            ...
            (eq, "$kaos_kings_prince", 0), 
            (eq, "$current_startup_quest_phase", 0),
       ],"Join a caravan to Madrid, in the Spanish Empire.",
       [
         (assign, "$current_town", "p_town_57"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Madrid"),
		 
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
         (change_screen_return),
       ]),

      ("town_9",[            (eq, "$kaos_kings_kingdom", 0), 
            (eq, "$kaos_kings_vassal", 0), 
            (eq, "$kaos_kings_prince", 0), 

            (eq, "$current_startup_quest_phase", 0),
],"Join a caravan to Amsterdam, in the United Provincies.",
       [
         (assign, "$current_town", "p_town_56"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Amsterdam"),
	 ...
	 ("town_10",[
            ...
            (eq, "$current_startup_quest_phase", 0),
        ],"Join a caravan to London, in the Kingdom of England.",
       [
         (assign, "$current_town", "p_town_59"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_London"),
		 
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
         (change_screen_return),
       ]),
      ("town_11",[            (eq, "$kaos_kings_kingdom", 0), 
            (eq, "$kaos_kings_vassal", 0), 
            (eq, "$kaos_kings_prince", 0), 

            (eq, "$current_startup_quest_phase", 0),
 ],"Join a caravan to Paris, in the The Kingdom of France.",
       [
         (assign, "$current_town", "p_town_58"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Paris"),		 
         (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
         (change_screen_return),
       ]),
	         ("town_1_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_1", "p_town_1", "fac_culture_1", "trp_knight_1_1", "trp_knight_2_1", "trp_kingdom_1_lord", "scn_town_1_castle"),
       ],"You take a caravan home to Warsaw.",
       [
         (assign, "$current_town", "p_town_1"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Warsaw"),
      ...
      ("town_2_king",
        ...
        ],"You take a caravan home to Moscow.",
       [
         (assign, "$current_town", "p_town_8"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Moscow"),
      ...
      ("town_3_king",
        ...
        ],"You take a caravan home to Sofia.",
       [
         (assign, "$current_town", "p_town_10"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Sofia"),
      ...
      ("town_4_king",
        [
            ...
            (call_script,"script_set_player_kingdom_init", "fac_kingdom_4", "p_town_52", "fac_culture_4", "trp_knight_4_1", "trp_knight_5_1", "trp_kingdom_4_lord", "scn_town_52_castle"),
        ],"You take a ship home to Stockholmh.",
       [
         (assign, "$current_town", "p_town_52"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Stockholmh"),
      ...
      ("town_5_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_5", "p_town_26", "fac_culture_5", "trp_knight_5_1", "trp_knight_6_1", "trp_kingdom_5_lord", "scn_town_26_castle"),
        ],"You take a ship home to Hamburg.",
       [
         (assign, "$current_town", "p_town_26"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Hamburg"),
      ...
      ("town_6_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_6", "p_town_23", "fac_culture_6", "trp_knight_6_1", "trp_knight_7_1", "trp_kingdom_6_lord", "scn_town_23_castle"),
    ],"You take a caravan home to Aalborg.",
       [
         (assign, "$current_town", "p_town_23"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Aalborg"),
      ...
      ("town_7_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_7", "p_town_55", "fac_culture_7", "trp_knight_7_1", "trp_knight_8_1", "trp_kingdom_7_lord", "scn_town_55_castle"),
    ],"You take a caravan home to Prague.",
       [
         (assign, "$current_town", "p_town_55"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Prague"),
      ...
      ("town_8_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_8", "p_town_57", "fac_culture_8", "trp_knight_8_1", "trp_knight_9_1", "trp_kingdom_8_lord", "scn_town_57_castle"),
    ],"You take a caravan home to Madrid.",
       [
         (assign, "$current_town", "p_town_57"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Madrid"),
      ...
      ("town_9_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_9", "p_town_56", "fac_culture_9", "trp_knight_9_1", "trp_knight_10_1", "trp_kingdom_9_lord", "scn_town_56_castle"),
    ],"You take a caravan home to Amsterdam.",
       [
         (assign, "$current_town", "p_town_56"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Amsterdam"),
      ...
      ("town_10_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_10", "p_town_59", "fac_culture_10", "trp_knight_10_1","trp_knight_11_1",  "trp_kingdom_10_lord", "scn_town_59_castle"),
    ],"You take a caravan home to London.",
       [
         (assign, "$current_town", "p_town_59"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_London"),
      ...
      ("town_11_king",
        [
          ...
          (call_script,"script_set_player_kingdom_init", "fac_kingdom_11", "p_town_58", "fac_culture_11", "trp_knight_11_1", "trp_knight_1_1_wife", "trp_kingdom_11_lord", "scn_town_58_castle"),
    ],"You take a caravan home to Paris.",
       [
         (assign, "$current_town", "p_town_58"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Paris"),
      ...
      ("town_9_prince_1",
        [
            ...
            (eq, "$kaos_kings_prince", 9), 
            #(call_script,"script_set_player_prince_init", "fac_kingdom_9", "trp_knight_9_1", "trp_knight_10_1", "trp_kingdom_9_lord"),
        ],"You take a caravan to Amsterdam.",
       [
         (assign, "$current_town", "p_town_56"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_Amsterdam"),
      ...
      ("town_11_prince",
        [
            ...
            (call_script,"script_set_player_prince_init", "fac_kingdom_11", "trp_knight_11_1","trp_knight_11_2", "trp_knight_1_1_wife", "trp_kingdom_11_lord"),
            (str_store_party_name, s55, "$kaos_prince_start"),
        ],"You take a caravan home to {s55}.",
       [
         (assign, "$current_town", "$kaos_prince_start"),
      ...
      ("town_11_vassal",
        [
            ...
            (call_script,"script_set_player_vassal_init", "fac_kingdom_11", "trp_knight_11_1", "trp_knight_1_1_wife", "trp_kingdom_11_lord"),
            (str_store_party_name, s55, "$kaos_vasal_start"),
        ],"You take a caravan home to {s55}.",
       [
         (assign, "$current_town", "p_town_58"),
...
##      ]),
      ...
      [
        ...
        (troop_clear_inventory, "$g_player_troop"),
        (troop_add_item, "$g_player_troop","itm_swedish_boots_b1_combined",0),
        (troop_add_item, "$g_player_troop","itm_old_buff_coat_combined",0),
        (troop_add_item, "$g_player_troop","itm_practice_sword",0),
        (troop_add_item, "$g_player_troop","itm_quarter_staff",0),
        (troop_equip_items, "$g_player_troop"),
        (set_visitor,0,"trp_player"),
...
##           (try_end),
      (try_begin),      
        ...
        (troop_raise_skill, "trp_player",skl_tactics,6),
        ...
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,150),
        (troop_raise_proficiency, "trp_player",wpt_two_handed_weapon,150),
        (troop_add_item, "trp_player","itm_good_gloves",imod_battered),
        (troop_add_item, "trp_player","itm_crown_swadia",imod_battered),
        (troop_add_item, "trp_player","itm_cuirassier5",imod_battered),
		(troop_add_item, "trp_player","itm_goodrapier4",imod_battered),		
  ...
  (else_try),
	...
	(troop_add_item, "trp_player","itm_goodrapier4",0),
      ...
      (else_try),
        ...
        (troop_add_item, "trp_player","itm_cheapsword1",0),
        (troop_add_gold, "trp_player", 100),        
      (else_try),
        (eq,"$background_type",cb_merchant),
        (troop_raise_attribute, "trp_player",ca_intelligence,2),
      ...
      (else_try),
        ...
        (troop_add_item, "trp_player","itm_cheapsword2",0),
      ...
      (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_archery,30),
        (troop_raise_proficiency, "trp_player",wpt_throwing,10),
        (troop_add_item, "trp_player","itm_cheapsword1",imod_battered),
 ...
 (else_try),
  ...
  (try_begin),
        ...
        (troop_add_gold, "trp_player", 10),
        (troop_add_item, "trp_player","itm_norm_bullets",0),
        (troop_add_item, "trp_player","itm_new_bandolet",0),
        (troop_add_item, "trp_player","itm_light_buff_coat_b_combined",imod_tattered),
        (troop_add_item, "trp_player","itm_swedish_boots_a1_combined",imod_tattered),          
        (troop_add_item, "trp_player","itm_cheapsword1", imod_rusty),
    ...
    (else_try),
        ...
        (troop_raise_skill, "trp_player","skl_spotting",1),
        (try_begin),
        (this_or_next|player_has_item,"itm_selo_boots"),
        (troop_has_item_equipped,"trp_player","itm_selo_boots"),
        (troop_remove_item, "trp_player","itm_selo_boots"),
        (try_end),
        (troop_add_item, "trp_player","itm_turkish_helmet_b1_combined",imod_crude),
        (troop_add_item, "trp_player","itm_turkish_heavy_f",imod_crude),
        (troop_add_item, "trp_player","itm_turk_boots_b",imod_crude),
        (troop_add_item, "trp_player","itm_turk_broadsword_a",imod_plain),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_battleaxe1",imod_chipped),
        (troop_add_item, "trp_player","itm_blue_buff_coat_combined",0),
        (troop_add_item, "trp_player","itm_swedish_boots_b1_combined",0),
        (troop_add_item, "trp_player","itm_new_whellock_pistol",0),
        (troop_add_item, "trp_player","itm_norm_bullets",0),
        (troop_add_item, "trp_player","itm_sumpter_horse",imod_heavy),
        (troop_add_item, "trp_player","itm_dried_meat",0),
        (troop_add_item, "trp_player","itm_dried_meat",0),
    ...
    (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,15),
        (troop_add_gold, "trp_player", 100),
        (troop_add_item, "trp_player","itm_selo_boots",imod_ragged),
        (troop_add_item, "trp_player","itm_evropa_odejda_sela",0),  
        (troop_add_item, "trp_player","itm_cheapsword3", imod_balanced),
        (troop_add_item, "trp_player","itm_old_pistol",0),
        (troop_add_item, "trp_player","itm_bad_bullets",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_swed_selyanin_b",0),
        (troop_add_item, "trp_player","itm_bad_boots_p",imod_ragged),
        (troop_add_item, "trp_player","itm_brownhat1",0),
        (troop_add_item, "trp_player","itm_staff",0),
        (troop_add_item, "trp_player","itm_pistol_firelock_long",0),
        (troop_add_item, "trp_player","itm_bad_bullets",0),
        (troop_add_item, "trp_player","itm_saddle_horse",0),
        (troop_add_item, "trp_player","itm_sumpter_horse",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_cavalry_gloves",imod_ragged),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_landsknecht_swad",imod_sturdy),
        (troop_add_item, "trp_player","itm_selo_boots",imod_ragged),
        (troop_add_item, "trp_player","itm_cheapsword2", imod_rusty),
        (troop_add_item, "trp_player","itm_new_whellock_pistol", 0),
        (troop_add_item, "trp_player","itm_bad_bullets", 0),
        (troop_add_item, "trp_player","itm_saddle_horse",imod_swaybacked),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
    (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_crossbow,10),
        (troop_raise_proficiency, "trp_player",wpt_throwing,10),
        (troop_add_item, "trp_player","itm_halfplate_swad",imod_ragged),
        (troop_add_item, "trp_player","itm_infantry_boots",imod_tattered),
        (troop_add_item, "trp_player","itm_cheapsword2", imod_rusty),
        (troop_add_item, "trp_player","itm_new_bandolet",0),
        (troop_add_item, "trp_player","itm_norm_bullets",0),
        (troop_add_item, "trp_player","itm_saddle_horse",imod_swaybacked),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_pilgrim_hood",imod_sturdy),
        (troop_add_item, "trp_player","itm_rich_baba_pol_2",imod_sturdy),
        (troop_add_gold, "trp_player", 100),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,10),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_red_buff_coat_combined",imod_sturdy),
        (troop_add_item, "trp_player","itm_swedish_boots_a1_combined",0),
        (troop_add_item, "trp_player","itm_german_rapier_c", imod_rusty),
        (troop_add_item, "trp_player","itm_old_pistol", 0),
        (troop_add_item, "trp_player","itm_bad_bullets", 0),
        (troop_add_item, "trp_player","itm_saddle_horse",imod_swaybacked),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
...
#          (neq, "$encountered_party_hostile", 0),
         (neg|troop_is_wounded, "trp_player"),
##          (store_troop_health,reg(0),"trp_player"),
##          (ge,reg(5),20),
		## PreBattle Orders Begin
		(party_slot_eq, "p_main_party", slot_party_prebattle_plan, 0),
		## PreBattle Orders End
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             (try_begin),
              ...
              (else_try),  
                 ...
                 (assign, ":troop_of_merchant", "trp_Palatinate_merchant"),
              (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_8"),
                 (assign, ":troop_of_merchant", "trp_Spanish_merchant"),
              (else_try), 
                 (eq, "$g_encountered_party_faction", "fac_kingdom_9"),
                 (assign, ":troop_of_merchant", "trp_Dutch_merchant"),
              (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_10"),
                 (assign, ":troop_of_merchant", "trp_England_merchant"),
              (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_11"),
                 (assign, ":troop_of_merchant", "trp_France_merchant"),
...
What kind of recruits do you want?",
   ...
   ("recruiter_faction_1",  [(eq, "$recruiter_amount_check", 0)],
         "Polish-Lithuanian Commonwealth",               [(assign,"$temp","fac_kingdom_1"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_2", [(eq, "$recruiter_amount_check", 0)],
         "Muscovite Tsardom",              [(assign,"$temp","fac_kingdom_2"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_3", [(eq, "$recruiter_amount_check", 0)],
         "Ottoman Empire",              [(assign,"$temp","fac_kingdom_3"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_4", [(eq, "$recruiter_amount_check", 0)],
         "Kingdom of Sweden",              [(assign,"$temp","fac_kingdom_4"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_5", [(eq, "$recruiter_amount_check", 0)],
         "Holy Roman Empire",              [(assign,"$temp","fac_kingdom_5"),(jump_to_menu, "mnu_recruiter_payment_2")]),
      
   ("recruiter_faction_6", [(eq, "$recruiter_amount_check", 0)],
         "Kingdom of Denmark",              [(assign,"$temp","fac_kingdom_6"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_7", [(eq, "$recruiter_amount_check", 0)],
         "The Palatinate",              [(assign,"$temp","fac_kingdom_7"),(jump_to_menu, "mnu_recruiter_payment_2")]),
      
   ("recruiter_faction_8", [(eq, "$recruiter_amount_check", 0)],
         "Spanish Empire",              [(assign,"$temp","fac_kingdom_8"),(jump_to_menu, "mnu_recruiter_payment_2")]),

   ("recruiter_faction_9", [(eq, "$recruiter_amount_check", 0)],
         "United Provincies",              [(assign,"$temp","fac_kingdom_9"),(jump_to_menu, "mnu_recruiter_payment_2")]),
      
   ("recruiter_faction_10", [(eq, "$recruiter_amount_check", 0)],
         "kingdm of England",              [(assign,"$temp","fac_kingdom_10"),(jump_to_menu, "mnu_recruiter_payment_2")]),
      
   ("recruiter_faction_11", [(eq, "$recruiter_amount_check", 0)],
         "Kingdom of France",              [(assign,"$temp","fac_kingdom_11"),(jump_to_menu, "mnu_recruiter_payment_2")]),
 ...
 (
  ...
  [
      ("Polish-Lithuanian Commonwealth",[
       ...
       (assign,"$kaos_kings_vassal", 1),
       (assign, reg3, "$character_gender"),
       (str_store_string,s11,"@Because of the old debt King Sigismund III Vasa owed your father he has taken you in as a vassal of Polish-Lithuanian Commonwealth"),         
    ...
    ("Muscovite Tsardom",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Tsar Michael I owed your father he has taken you in as a vassal of Muscovite Tsardom"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
    ...
    ("Ottoman Empire",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Sultan Osman IIowed your father he has taken you in as a vassal of Ottoman Empire"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),

    ("Sweden",[
        ],"Gustav II Adolf_av Sverige",[
       (assign,"$kaos_kings_vassal", 4),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Gustav II Adolf_av Sverige owed your father he has taken you in as a vassal of Kingdom of Sweden"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),

      ("Holy Roman Empire",[
        ],"Ferdinand von Osterreich",[
       (assign,"$kaos_kings_vassal", 5),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Ferdinand von Osterreich owed your father he has taken you in as a vassal of Holy Roman Empire"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ...
  ("Denmark",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Christian IV af Danmark owed your father he has taken you in as a vassal of Kingdom of Denmark"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("Palatinate",[
        ],"Friedrich von der Pfalz",[
       (assign,"$kaos_kings_vassal", 7),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Friedrich von der Pfalz owed your father he has taken you in as a vassal of The Palatinate"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("Spanish Empire",[
        ],"King Felipe III",[
       (assign,"$kaos_kings_vassal", 8),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt King Felipe III owed your father he has taken you in as a vassal of Spanish Empire"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("United Provincies",[
        ],"Maurice of Nassau Friedrich_V",[
       (assign,"$kaos_kings_vassal", 9),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt Maurice of Nassau Friedrich_V owed your father he has taken you in as a vassal of United Provincies"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("kingdom of England",[
        ],"King James I",[
       (assign,"$kaos_kings_vassal", 10),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt King James I owed your father he has taken you in as a vassal of kingdom of England"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
 ("kingdom of France",[
        ],"King Louis_XIII",[
       (assign,"$kaos_kings_vassal", 11),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@Because of the old debt King Louis_XIII owed your father he has taken you in as a vassal of kingdom of France"),        
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ...
  ("Palatinate",[
       ...
       (assign,"$kaos_kings_prince", 7),
      (assign, reg3, "$character_gender"),
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("Spanish Empire",[
        ],"King Felipe III",[
       (assign,"$kaos_kings_prince", 8),
      (assign, reg3, "$character_gender"),
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("United Provincies",[
        ],"Maurice of Nassau Friedrich V",[
       (assign,"$kaos_kings_prince", 9),
      (assign, reg3, "$character_gender"),
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("kingdom of England",[
        ],"King James I",[
       (assign,"$kaos_kings_prince", 10),
      (assign, reg3, "$character_gender"),
    (jump_to_menu,"mnu_start_character_4"),
    ]),
 ("kingdom of France",[
        ],"King Louis XIII",[
       (assign,"$kaos_kings_prince", 11),
      (assign, reg3, "$character_gender"),
    (jump_to_menu,"mnu_start_character_4"),
    ]),
  ("go_back",[],"Go back.",
  ...
  [
      ("Polish-Lithuanian Commonwealth",[
        ],"Your father was King Sigismund III_Vasa",[
       (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
       ...
       (assign, reg3, "$character_gender"),
       (assign, "$kaos_kings_kingdom", 1),
       (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Polish-Lithuanian Commonwealth"),
      (jump_to_menu,"mnu_choose_skill"),
    ]),

    ("Muscovite Tsardom",[
        ],"Your father was Tsar Michael I",[
            (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Muscovite Tsardom"),
    (jump_to_menu,"mnu_choose_skill"),
    ]),

    ("Ottoman Empire",[
        ],"Your father was Sultan Osman II ",[
            (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Ottoman Empire"),
    (jump_to_menu,"mnu_choose_skill"),
    ]),

    ("Kingdom of Sweden",[
        ],"Your father was Gustav II Adolf_av Sverige",[
            (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Kingdom of Sweden"),
    (jump_to_menu,"mnu_choose_skill"),
    ]),

      ("Holy Roman Emprie",[
        ],"Your father was Ferdinand von Osterreich",[
            (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Holy Roman Empire"),
    (jump_to_menu,"mnu_choose_skill"),
    ]),

  ("Denmark",[
        ],"Your father was Christian IV af Danmark",[
            (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Kingdom of Denmark"),
    (jump_to_menu,"mnu_choose_skill"),
    ]),
  ("Palatinate",[
        ],"Your father was Friedrich von der Pfalz",[
             (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Palatinate"),
	  (jump_to_menu,"mnu_choose_skill"),
    ]),
  ("Spanish Empire",[
        ],"Your father was King Felipe III",[
             (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (assign, reg3, "$character_gender"),
     (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the Spanish Empire"),
 
 (jump_to_menu,"mnu_choose_skill"),
    ]),

	("United Provincies",[
        ],"Your father was Maurice of Nassau Friedrich V",[
             (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (assign, reg3, "$character_gender"),
     (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the United Provincies"),

	  (jump_to_menu,"mnu_choose_skill"),
    ]),
 
 ("kingdom of England",[
        ],"Your father was King James I",[
             (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (assign, reg3, "$character_gender"),
     (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the kingdom of England"),

	  (jump_to_menu,"mnu_choose_skill"),
    ]),
 ("kingdom of France",[
        ],"Your father was King Louis XIII",[
             (assign,"$background_answer_2", cb2_page),
       (try_begin),
            (eq,"$character_gender",tf_female),
            (assign,"$background_answer_3",cb3_lady_in_waiting),
      ...
      (assign, reg3, "$character_gender"),
     (str_store_string,s11,"@You are your fathers {reg3?daughter:son}, and the death of of your father has left you to fill his spot as leader of the kingdom of France"),
